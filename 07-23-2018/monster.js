...
Monster.prototype.toString = function() {
    var description = `
                    <p>A ${this.eyes}-eyed <span class="colorBlock" style="background-color: ${this.color};">&nbsp</span> 
                    haired monster that ${this.getMovementText()} and attacks with ${this.arms} arms.
                    </p>`;
    return description;
}
...
window.onload = function() {
    ...
    submitButton.addEventListener('click', function() {
        ...
        try {
            ...
            output.innerHTML = monster.toString();
        } catch (e) {
